...
This folder contains my **n8n workflow automation projects**, showcasing how I use **no-code/low-code tools** to automate data processing, filtering, and transformation tasks.  
...
- **Description:** Automated a workflow that filters a list of names to include only those starting with “E,” then generates a personalized greeting for each.  
